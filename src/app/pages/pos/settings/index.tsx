      ...
      {availableGroups.map((g) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[0.8125rem] truncate">{t(g.labelKey)}</p>
            <p className="text-[0.625rem] opacity-60 truncate">{t(g.descKey)}</p>
          </div>
    ...
    <div className={`h-full flex flex-col ${tc.page} overflow-hidden`}>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h1 className={`text-[1.125rem] ${tc.heading}`}>{t("settings.pageTitle")}</h1>
          {!isAdmin && (
            <span
                ...
                <>
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <h2 className={`text-[1rem] ${tc.heading}`}>{t("settings.drawerTitle")}</h2>
